...
BabyNames%>%
  filter(name %in% c("John", "James", "Sofia", "Ava", "Emily"))%>%
  group_by(name,year)%>%
...
It will look like a graph with moving lines similar to the example 

### Step 3 

##### What variable(s) from the raw data table do not appear at all in the graph?

I have removed sex from the equation as it is irrelevant and I simply want the counts of each name regardless of sex.
...
Count is no longer total count but the count of name total per year. 

### Step 4

##### Have cases been filtered out?

I removed all names I was uninterested in with the filter function.  


##### Have cases been grouped and summarized within groups in any way?

 The cases have been grouped by name count in each year. That way graphically we can see how name use rises and falls through out time. 


##### Have any new variables been introduced?  If so, what the relationship between the new variables and existing variables?

No new variables have been added to my data.
